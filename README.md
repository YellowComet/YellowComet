...
- POS_LARADI
  ...
  - Stack: TypeScript (97.1%), CSS (1.4%), JavaScript (1.3%)
  - Estado: WIP/MVP
  - Enfoque: arquitectura modular, componentes desacoplados, tipado fuerte
  - Enlace: https://github.com/YellowComet/POS_LARADI

- POS-frontend
  - Tipo: Interfaz POS
  - Stack: JavaScript (33.7%), CSS (32.4%), PHP (17.6%), SCSS (11.3%), Blade (4.8%)
  - Estado: WIP
  - Enfoque: vistas dinámicas y estilos escalables; plantillas Blade
  - Enlace: https://github.com/YellowComet/POS-frontend

- ScraperFutbol
  - Tipo: Scraper de datos futbolísticos
  - Stack: HTML (73%), Python (25.1%), JavaScript (1.9%)
  - Estado: Prototipo/WIP
  - Enfoque: extracción y normalización de datos para análisis/uso posterior
...
> ¿Quieres ver el código? Puedo preparar un mirror sanitizado o un walkthrough (vídeo) bajo solicitud.

---

## 📊 Lenguajes por repositorio (resumen)

| Repositorio                 | Lenguajes principales                                           |
|----------------------------|------------------------------------------------------------------|
| POS_LARADI                 | TypeScript 97.1% • CSS 1.4% • JavaScript 1.3% • Other 0.2%      |
| POS-frontend               | JavaScript 33.7% • CSS 32.4% • PHP 17.6% • SCSS 11.3% • Blade 4.8% |
| ScraperFutbol              | HTML 73% • Python 25.1% • JavaScript 1.9%                       |
...
- Primero claridad, luego complejidad necesaria
- Tipado y pruebas como aceleradores (no como freno)
- Iteraciones cortas, feedback temprano, decisiones documentadas
...
- Disponibilidad: abierto a colaborar en proyectos con impacto y buenas prácticas

---

### 📝 Notas para reclutadores
- Puedo compartir repos privados o un vídeo demo a pedido
- Prefiero conversaciones técnicas con ejemplos concretos y criterios de aceptación

<sub>Última actualización: 2025-12-28</sub>
